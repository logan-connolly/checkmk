...
> [!NOTE]
> The _Environment setup_ and _Executing tests_ sections have **external** and
> **internal** documentation. The internal documentation is tailored
> towards Checkmk developers using our infrastructure, while the external
> documentation is for third-party contributors.

Here are the links to major sections of this document:

* [Contributing Code](#contributing-code)
* [Environment setup](#environment-setup)
* [Making changes](#how-to-change-checkmk)
...
To set up the development environment, you first need to [fork the repository and clone to your computer](https://help.github.com/en/github/getting-started-with-github/fork-a-repo). Once completed, change into the repository directory:

```console
cd checkmk
```

You will then need to bootstrap your environment:

- [external documentation](./doc/contributing/external.md): if you're an
external contributor.
- [internal documentation](./doc/contributing/internal.md): if you work at
Checkmk.
...
This section will show you how to validate changes locally via tests along with
formatting, linting, and typing commands. If you're changes passes these
checks, there's a good chance that your PR will be accepted.

- [external documentation](./doc/contributing/external.md#executing-tests):
  if you're an external contributor.
- [internal documentation](./doc/contributing/internal.md#executing-tests):
  if you work at Checkmk.
